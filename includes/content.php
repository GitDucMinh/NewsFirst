    ...
    <div class="row" data-aos="fade-up">
      <div class="col-md-8 stretch-card grid-margin">
          <?php
              ...
              //   $qr = 'SELECT theloai.tenTL FROM theloai INNER JOIN tin ON theloai.id = '.$row["idTL"].' limit 1';
              //   $category = mysqli_query($conn, $qr);
              //   $cate = mysqli_fetch_array($category);
              //   echo '
              //   <div class="position-relative">
              //     <img src="admin/posts/uploads/'.$row['urlHinh'].'" alt="banner" class="img-fluid"/>
              //     <div class="banner-content">
              //       <div class="badge badge-danger fs-12 font-weight-bold mb-3">'.$cate['tenTL'].' </div>
              //       <h1 class="mb-0">'.$row['tieude'].'</h1>
            ...
            <?php
              ...
              while($row1 = $result->fetch_array()) {
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="index.html">'.$row1["tenTL"].'</a>
                </li>
                ';
              }
            ?>
